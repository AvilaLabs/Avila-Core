...
3. What exact evidence does the eventual reviewer require?
4. Who is qualified to own each method and approve its applicability boundary?
...
5. What qualification framework is credible to the first market without
...
5. Does a second qualified provider create a substitutable result or merely a
   different method?
