...
| SHIELD-R2-neutron | fail | bounded.le.exceeds | -11.37 |
| SHIELD-R3-photon | fail | bounded.le.exceeds | -25.08 |
| SHIELD-R4-mass | pass | bounded.le.within | 597.6 |
| SHIELD-R5-thickness | pass | bounded.le.within | 4 |
...
| SHIELD-R2-neutron | fail | bounded.le.exceeds | -11.28 |
| SHIELD-R3-photon | pass | bounded.le.within | 1.195 |
| SHIELD-R4-mass | pass | bounded.le.within | 30.1 |
| SHIELD-R5-thickness | fail | bounded.le.exceeds | -1 |
...
| SHIELD-R2-neutron | fail | bounded.le.exceeds | -13.74 |
| SHIELD-R3-photon | fail | bounded.le.exceeds | -0.4881 |
| SHIELD-R4-mass | fail | bounded.le.exceeds | -568.9 |
| SHIELD-R5-thickness | pass | bounded.le.within | 9 |
| SHIELD-R6-activation | fail | nominal.le.exceeds | -3.277 |
