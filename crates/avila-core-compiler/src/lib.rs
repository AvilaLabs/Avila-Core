...
pub use document::{
    AuthoredBinding, BasisKind, COMPILE_REPORT_SCHEMA_VERSION, COMPILED_CONTRACT_SCHEMA_VERSION,
    CONTRACT_SCHEMA_VERSION, CapabilityTypeDefinition, Comparison, ContractInput, ContractSource,
    ContractStatus, InputSlotDefinition, KindRecord, OutputSlotDefinition, REGISTRY_SCHEMA_VERSION,
