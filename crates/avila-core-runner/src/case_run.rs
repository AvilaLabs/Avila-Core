...
use avila_core_compiler::{
    ...
    EnvelopeState, FindingClass, ImmutablePolicyRef, PresentationGateState, ResolvedBinding,
    ReviewDisposition, ReviewIndependence, ReviewerRole, SourceLocation, SourceRef,
    assess_coverage, compile_documents, evaluate_campaign, evaluate_envelope,
...
use crate::attempt::{
    AttemptChange, AttemptComparison, AttemptLineageRequest, AttemptRecord, prepare_attempt,
};
...
#[cfg(test)]
use compare::compare_attempt_results;
use compare::{compare_attempt_to_parent, margins, write_attempt_comparison};
